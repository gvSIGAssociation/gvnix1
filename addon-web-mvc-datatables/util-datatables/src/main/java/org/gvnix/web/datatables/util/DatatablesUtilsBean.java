...
public interface DatatablesUtilsBean {
    ...
    /**
     * Returns if a Datatables filter parameter is a special one, exclusively
     * used by other component or feature that should implements a custom
     * implementation
     * 
     * @param name Name of filter parameter to check
     * @return True if given filter parameter is exclusively used by other
