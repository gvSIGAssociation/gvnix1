...
public class DatatablesMetadata extends
    ...
    private void buildListDatatablesRequesMethodAjaxBody(
        ...
        // [Code generated] String parentTableHashId =
        // params.remove("dtt_parent_table_id_hash");
        bodyBuilder
                .appendFormalLine("String parentTableHashId = params.remove(\"dtt_parent_table_id_hash\");");

        // [Code generated] if (StringUtils.isNotBlank(parentTableHashId)) {
        bodyBuilder.appendFormalLine(String.format(
                "if (%s.isNotBlank(parentTableHashId)) {",
                helper.getFinalTypeName(STRING_UTILS)));
        bodyBuilder.indent();
        ...
        // parentTableHashId);
        bodyBuilder
                .appendFormalLine("uiModel.addAttribute(\"dtt_parent_table_id_hash\", parentTableHashId);");
        ...
        // params.remove("dtt_table_id_hash");
        bodyBuilder
                .appendFormalLine("String tableHashId = params.remove(\"dtt_table_id_hash\");");

        // [ Code generated] if (StringUtils.isNotBlank(tableHashId)
        // && !uiModel.containsAttribute("dtt_table_id_hash")) {
        bodyBuilder
                .appendFormalLine(String
                        .format("if (%s.isNotBlank(tableHashId) && !uiModel.containsAttribute(\"dtt_table_id_hash\")) {",
                                helper.getFinalTypeName(STRING_UTILS)));
        bodyBuilder.indent();

        // [Code generated] uiModel.addAttribute("dtt_table_id_hash",
        // tableHashId);
        bodyBuilder
                .appendFormalLine("uiModel.addAttribute(\"dtt_table_id_hash\", tableHashId);");
