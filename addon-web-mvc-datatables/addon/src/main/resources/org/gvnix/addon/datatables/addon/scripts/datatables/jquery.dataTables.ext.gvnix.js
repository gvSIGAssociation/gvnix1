...
/**
 * This function register new aoOnDataChangeCallback on gvNIX Datatable
 */
jQuery.fn.dataTableExt.oApi.fnRegisterDataChangeCallback = function(oSettings, fn){
	// Creating new callback
	oSettings['aoOnDataChangeCallback'] = [];
	oSettings.oApi._fnCallbackReg(oSettings, 'aoOnDataChangeCallback', fn);
};


/**
 * This function execute callback using Datatables API
 */
jQuery.fn.dataTableExt.oApi.fnCallbackFire = function(oSettings, sCallbackName){
	var _that = this;
	_that.oApi._fnCallbackFire(oSettings, sCallbackName);
};
