...
##  * ${ROO_COMMAND}: Roo shell executable path. Should be "gvnix.sh" (with execution permission)
...
show_message_info "Starting Roo scripts"
	...
	## clinic
  test_simple clinic clinic.roo $TOMCAT_PORT

	## embedding
  test_simple embedding embedding.roo $TOMCAT_PORT

	## multimodule
  test_simple multimodule multimodule.roo $TOMCAT_PORT

	## pizzashop
  test_simple pizzashop pizzashop.roo $TOMCAT_PORT

	## vote
  test_simple vote vote.roo $TOMCAT_PORT

	## wedding
  test_simple wedding wedding.roo $TOMCAT_PORT
...
show_message_info "Starting general scripts"
  ...
  test_simple "gvnix-sample" $GVNIX_HOME/src/main/resources/gvnix-sample.roo $TOMCAT_PORT
	...
	## script
  ## TODO check this
  #test_compile "gvnix-script" $GVNIX_HOME/src/main/resources/script.roo
	
	## tiendavirtual
  ## TODO check this
  #test_simple "tiendavirtual" $GVNIX_HOME/src/main/resources/tiendavirtual.roo $TOMCAT_PORT

##
## gvNIX add-safe
##
show_message_info "Starting safe scripts"
	## safe 
  test_simple "safe" $GVNIX_HOME/src/test/resources/security-safe.roo $TOMCAT_PORT

##
## gvNIX FancyTree addon tests
##
show_message_info "Starting FancyTree Add-On scripts"
# FancyTree
test_simple "fancytree" $GVNIX_HOME/src/test/resources/fancytree.roo $TOMCAT_PORT
