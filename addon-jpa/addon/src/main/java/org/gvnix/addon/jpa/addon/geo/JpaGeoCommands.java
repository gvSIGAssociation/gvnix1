...
public class JpaGeoCommands implements CommandMarker {
    ...
    public void addField(
            ...
            @CliOption(key = "srs",
                    ...
                    help = "The code of coordinate reference system to show this field on a map (numbers only)") final int srs) {
        ...
        operations.addFieldByProvider(fieldName, fieldGeoType, entity, srs);
    }
    ...
    public void addFinderGeoAdd(
            ...
            @CliOption(key = "field",
                    mandatory = false,
                    optionContext = UPDATE_PROJECT,
                    help = "Field for which you want generate the finder") final JavaSymbolName field) {
        ...
        operations.addFinderGeoAddByProvider(entity, field);
    }
