...
import org.gvnix.addon.jpa.addon.geo.providers.hibernatespatial.*;
...
public class JpaGeoOperationsImpl implements JpaGeoOperations {
    ...
    public void addFieldByProvider(JavaSymbolName fieldName,
            FieldGeoTypes fieldGeoType, JavaType entity, int srs) {
        GeoProvider provider = null;
        // Getting all providersorg.hibernate.spatial.GeometryType
        for (GeoProvider tmpProvider : providers) {
            // If some provider says that his GEO persistence is installed
        ...
        provider.addField(fieldName, fieldGeoType, entity, srs);
    ...
    public void addFinderGeoAddByProvider(JavaType entity,
        ...
        provider.addFinderGeoAdd(entity, fieldName);
    ...
    /**
     * Lazy provides a TypeManagementService.
     * 
